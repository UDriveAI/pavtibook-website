                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                ...
                                subtitle: Text(
                                  '${receipt.donorName ?? "Guest"} • $dateStr',
                                  style: TextStyle(
                  ...
                  secondChild: Column(
                    ...
                    children: [
                      ...
                      TweenAnimationBuilder<double>(
                        tween:
                            Tween<double>(begin: 0.0, end: ratio),
                        duration:
                        ...
                        builder: (context, val, _) => ClipRRect(
                          ...
                          child: LinearProgressIndicator(
                            ...
                            valueColor:
                                AlwaysStoppedAnimation<Color>(rcColor),
                          ),
                        ),
                      ),
                      const SizedBox(height: 12),
                      ...
                      TweenAnimationBuilder<double>(
                        ...
                        builder: (context, val, _) => ClipRRect(
                          ...
                          child: LinearProgressIndicator(
                            ...
                            backgroundColor: Colors.grey[200],
                            valueColor:
                                AlwaysStoppedAnimation<Color>(usColor),
                          ),
                        ),
                      ),
                      const SizedBox(height: 14),
